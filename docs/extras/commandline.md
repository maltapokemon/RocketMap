# Command line
    ...
    -ign IGNORE_LIST, --ignore-list IGNORE_LIST
                          List of Pokemon to ignore. Pokemon will not be added
                          to DB, not sent to webhooks, and not encountered. Will
                          still be used to determine spawnpoints. [env var:
                          POGOMAP_IGNORE_LIST]
